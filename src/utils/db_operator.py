...
class SQLQueryOperator:
    ...
    def __init__(self, config_path: str = None, user: str = None, password: str = None, host: str = None, port: str = None, name: str = None):
    ...
    def __call__(self, q):
        ...
        print(f'Retrieved {len(data)} datapoints in {round(end_time, 3)} seconds')
